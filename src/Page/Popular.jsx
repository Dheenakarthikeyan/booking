...
const Popular = ({ url }) => {
  ...
  return (
    ...
    <div className="container mx-auto">
      <Link to="/">
        <span className="p-4 m-10 text-xl border border-white rounded-xl bg-red text-white inline-block">
          Go To Home
        </span>
      </Link>

      <h2 className="text-3xl font-bold text-shadow-2xs pt-15 pl-10 ">Popular: </h2>
